...
class MATTrainer:
    ...
    def ppo_update(self, sample):
        ...
        imp_weights = torch.exp(action_log_probs - old_action_log_probs_batch)  # 维度为（batch_size，num_agent，1）
        ...
        return value_loss, critic_grad_norm, policy_loss, dist_entropy, grad_norm, imp_weights
